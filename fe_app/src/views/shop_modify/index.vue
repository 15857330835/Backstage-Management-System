<template>
  <div class="shop_add">
    ...
    >
      ...
      <el-form-item>
        <el-button type="primary" @click="shop_modify(ruleForm)">立即创建</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
...
export default {
  ...
  mounted(){
    ...
    const { _id,name,address,phone,intro,slogan,category,delivery,price,startTime,endTime,feature,imageUrl1,imageUrl2,imageUrl3 } = this.$route.query
    ...
    this.ruleForm.delivery = delivery
    this.ruleForm.price = price
    this.ruleForm.startTime = startTime
    this.ruleForm.endTime = endTime
    this.ruleForm.feature = feature
    this.ruleForm.imageUrl1 = imageUrl1
    this.ruleForm.imageUrl2 = imageUrl2
    this.ruleForm.imageUrl3 = imageUrl3
  },
  methods: {
    ...mapActions(["modify"]),
    async shop_modify(val) {
      const result =await this.modify(val);
      console.log(1)
